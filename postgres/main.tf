...
module "db_parameter_group" {
  source          = "../shared/instance_parameter_group"
...
module "db_subnet_group" {
  source          = "../shared/rds_subnet_group"
...
module "cw_log_group" {
  source                                = "../shared/cloudwatch_log_groups"
...
module "enhanced_monitoring_iam_role" {
  source                               = "../shared/enhanced_monitoring_role"
